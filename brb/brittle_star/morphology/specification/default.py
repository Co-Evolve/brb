...
def default_arm_segment_specification(alpha: float) -> BrittleStarArmSegmentSpecification:
...
def default_brittle_star_morphology_specification(num_arms: int = 5,
                                                  ...
                                                  use_p_control: bool = False) -> BrittleStarMorphologySpecification:
    ...
    actuation_specification = BrittleStarActuationSpecification(use_tendons=not use_p_control,
...
def default_arm_length_based_brittle_star_morphology_specification(num_arms: int = 5,
    ...
    return default_brittle_star_morphology_specification(num_arms=num_arms,
