...
from brb.toy_example.morphology.parts.arm import MJCFToyExampleArm
from brb.toy_example.morphology.parts.torso import MJCFToyExampleTorso
...
class MJCFToyExampleMorphology(MJCFMorphology):
    ...
    def _configure_camera(
        ...
        self.torso.mjcf_body.add(
                'camera', name='side_camera', pos=[0.0, -2., 2.5], quat=euler2quat(40 / 180 * np.pi, 0, 0), mode="track"
                )
