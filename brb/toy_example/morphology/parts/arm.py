...
from brb.toy_example.morphology.parts.arm_segment import MJCToyExampleArmSegment
from brb.toy_example.morphology.specification.specification import ToyExampleMorphologySpecification


class MJCToyExampleArm(MJCMorphologyPart):
    def __init__(
            self,
    ...
    def _build_segments(
        ...
        for segment_index in range(number_of_segments):
            ...
            segment = MJCToyExampleArmSegment(
                    parent=parent,
