...
from brb.toy_example.morphology.observables import ToyExampleObservables
from brb.toy_example.morphology.parts.arm import MJCToyExampleArm
from brb.toy_example.morphology.parts.torso import MJCToyExampleTorso
from brb.toy_example.morphology.specification.specification import ToyExampleMorphologySpecification


class MJCToyExampleMorphology(MJCMorphology):
    def __init__(
            self,
    ...
    def _build_observables(
        ...
        return ToyExampleObservables(self)
    ...
    def _build_arms(
        ...
        for arm_index in range(number_of_arms):
            ...
            arm = MJCToyExampleArm(
                    parent=self.torso, name=f"arm_{arm_index}", pos=position, euler=[0, 0, angle], arm_index=arm_index
                    )
